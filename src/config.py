...
class Config:
    ...
    t_one_audio_filter: str | None = "highpass=f=80,lowpass=f=3800,dynaudnorm=f=150:g=15"
...
def load_config() -> Config:
    ...
    return Config(
        ...
        t_one_ws_url=os.getenv("T_ONE_WS_URL", "ws://127.0.0.1:8080/api/ws").strip(),
        ...
        t_one_audio_filter=(os.getenv("T_ONE_AUDIO_FILTER", "highpass=f=80,lowpass=f=3800,dynaudnorm=f=150:g=15") or "").strip() or None,
